...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('categories_category_contains', (
        ...
        db.create_unique('categories_category_contains', ['category_id', 'course_id'])

        # Adding M2M table for field holds on 'Category'
        db.create_table('categories_category_holds', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_category', models.ForeignKey(orm['categories.category'], null=False)),
            ('to_category', models.ForeignKey(orm['categories.category'], null=False))
        ))
        db.create_unique('categories_category_holds', ['from_category_id', 'to_category_id'])
