...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notifications_event', (
            ...
            ('context', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['courses.Course'], null=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User'], null=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['documents.Document'], null=True)),
            ('thread', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['messages.Thread'], null=True)),
    ...
    models = {
        ...
        'notifications.event': {
            ...
            'context': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['courses.Course']", 'null': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['documents.Document']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['messages.Thread']", 'null': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['auth.User']", 'null': 'True'})
        },
