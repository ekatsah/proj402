...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.moderate'
        db.delete_column('users_userprofile', 'moderate')

    def backwards(self, orm):
        # Adding field 'UserProfile.moderate'
        db.add_column('users_userprofile', 'moderate',
