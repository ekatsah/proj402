...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_permission', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='back_user', to=orm['auth.User'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('users', ['Permission'])

        # Adding unique constraint on 'Permission', fields ['name', 'user', 'object_id']
        db.create_unique('users_permission', ['name', 'user_id', 'object_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Permission', fields ['name', 'user', 'object_id']
        db.delete_unique('users_permission', ['name', 'user_id', 'object_id'])
