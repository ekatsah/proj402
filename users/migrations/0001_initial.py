...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CourseFollow'
        db.create_table('users_coursefollow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Course'])),
            ('last_visit', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('visited', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('users', ['CourseFollow'])

        # Adding model 'UserProfile'
        db.create_table('users_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('registration', self.gf('django.db.models.fields.CharField')(max_length=80, null=True)),
            ('section', self.gf('django.db.models.fields.CharField')(max_length=80, null=True)),
            ('welcome', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('users', ['UserProfile'])

        # Adding M2M table for field courses on 'UserProfile'
        db.create_table('users_userprofile_courses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['users.userprofile'], null=False)),
            ('coursefollow', models.ForeignKey(orm['users.coursefollow'], null=False))
        ))
        db.create_unique('users_userprofile_courses', ['userprofile_id', 'coursefollow_id'])


    def backwards(self, orm):
        
        # Deleting model 'CourseFollow'
        db.delete_table('users_coursefollow')

        # Deleting model 'UserProfile'
        db.delete_table('users_userprofile')

        # Removing M2M table for field courses on 'UserProfile'
        db.delete_table('users_userprofile_courses')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 2, 20, 48, 49, 315885)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 2, 20, 48, 49, 315834)'}),
