...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PendingDocument'
        db.create_table('documents_pendingdocument', (
        ...
        db.send_create_signal('documents', ['PendingDocument'])

    def backwards(self, orm):
        # Deleting model 'PendingDocument'
        db.delete_table('documents_pendingdocument')
