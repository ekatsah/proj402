...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field threads on 'Page'
        db.create_table('documents_page_threads', (
        ...
        db.create_unique('documents_page_threads', ['page_id', 'thread_id'])
        ...
        db.create_table('documents_document', (
            ...
            ('refer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='back_course', to=orm['courses.Course'])),
            ('size', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('words', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('ready', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('done', self.gf('django.db.models.fields.IntegerField')()),
            ('points', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['upvotes.VoteDocument'])),
        ...
        # Adding M2M table for field threads on 'Document'
        db.create_table('documents_document_threads', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('document', models.ForeignKey(orm['documents.document'], null=False)),
            ('thread', models.ForeignKey(orm['messages.thread'], null=False))
        ))
        db.create_unique('documents_document_threads', ['document_id', 'thread_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field threads on 'Page'
        db.delete_table('documents_page_threads')
        ...
        # Removing M2M table for field threads on 'Document'
        db.delete_table('documents_document_threads')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 2, 20, 47, 13, 173333)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 2, 20, 47, 13, 173283)'}),
